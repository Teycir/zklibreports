...
/// @notice Stateful Medusa harness for initializeV2 non-atomic upgrade takeover.
contract MedusaLineaF2InitV2UpgradeGapHarness {
    ...
    function action_attacker_front_run_initializeV2() public {
        attacker.seizeMigrationState(address(proxy), ATTACKER_BLOCK, ATTACKER_ROOT);
    }

    function property_migration_anchor_remains_admin_controlled() public view returns (bool) {
