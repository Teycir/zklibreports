...
/// @notice Stateful Medusa harness for CustomBridgedToken initializeV2 takeover.
contract MedusaLineaF3CustomBridgedTokenInitV2TakeoverHarness {
    ...
    function property_bridge_control_remains_legitimate() public view returns (bool) {
