...
- Pass status (manual): exhausted for this pass.
- Full-source parity witness artifacts captured for `H1/H2/H3/H4` in `reports/cat1_bridges/LayerZero-v2/manual_artifacts/`.
